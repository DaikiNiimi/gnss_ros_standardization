...
| Sub | `/gnss/imu/data_raw` | `sensor_msgs/Imu` | EKF, `gnss_imu_fgo` |
| Pub | `/gnss/solution` (or example-specific) | `GnssSolution` | all examples |

## Tightly-coupled FGO examples

The two tightly-coupled FGO nodes (`gnss_fgo`, `gnss_imu_fgo`, in
[tightly_coupled_fgo/](tightly_coupled_fgo/)) demonstrate the core goal of this
